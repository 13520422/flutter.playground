...
class CCExpanded extends Component {
  static const String runType = "CCExpanded";
  ...
  static CCExpanded? fromJson(Map<String, dynamic> json) {
  ...
  static CCExpanded? fromWidget(Expanded widget) {
    var uuid = Uuid();
    // TODO: implement fromJson
    var component = CCExpanded(
      name: uuid.v4(),
  ...
  Map<String, dynamic> toJson() {
    ...
    json["runtimeType"] = CCExpanded.runType;
    json["name"] = name;
